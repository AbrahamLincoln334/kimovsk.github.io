...
<head>
    ...
    <title>Старт разработки | Администрация Кимовский район</title>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Старт <span>разработки</span> платформы</h2>
            </div>
        </div>
    </section>
            ...
            <div class="article-layout">
                <div class="article-main">
                    <div class="article-content">
                        <h1>Старт разработки платформы подготовки тендеров</h1>
                        <div class="article-meta"><span>25 ноября 2025</span><span>Отдел
                                разработки</span><span>1 234 просмотра</span></div>
                        <div class="article-body">
                            <p>Команда подрядчика приступила к написанию кода бэкенда и настройке серверной
                                инфраструктуры. Разработка ведётся с использованием стека Python/Django и PostgreSQL.
                            </p>

                            <h2>Этапы разработки</h2>
                            <ul>
                                <li>Ноябрь–Декабрь 2025: разработка бэкенда и базы данных</li>
                                <li>Январь–Февраль 2026: создание фронтенда и интерфейсов</li>
                                <li>Март 2026: интеграция с внешними системами</li>
                                <li>Апрель 2026: тестирование и бета-запуск</li>
                            </ul>
                        </div>
