...
<head>
    ...
    <title>Сопровождение закупок | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Сопровождение <span>закупочных процедур</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv7.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Полный цикл ведения тендера</h1>
                        <div class="article-meta"><span>Документы: под ключ</span><span>Риски:
                                минимизированы</span></div>
                        <div class="article-body">
                            <p>Экспертное сопровождение каждой закупки от формирования потребности до подписания
                                контракта. Мы берём на себя взаимодействие с ЕИС, проверку участников и контроль
                                регламентных сроков.</p>
                            <h2>Этапы сопровождения</h2>
                            <ul>
                                <li>Планирование и обоснование закупки</li>
                                <li>Подготовка и публикация извещения</li>
                                <li>Рассмотрение первых и вторых частей заявок</li>
                                <li>Оформление протоколов и заключение контракта</li>
                            </ul>
                            <p>Наши юристы и аналитики работают в паре с вашей контрактной службой, обеспечивая 100%
                                соответствие законодательству.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-law">44-ФЗ</span><span
                                class="news-tag tag-event">Процедуры</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-legal.php">
                                <div class="sidebar-news-date">
                                    <div class="day"></div>
                                </div>
                                <h4>Юридический аудит</h4>
                            </a></div>
                    </div>
                    <div class="sidebar-card">
