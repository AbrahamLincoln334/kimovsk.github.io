...
<head>
    ...
    <title>Информационная безопасность | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Обеспечение <span>информационной безопасности</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv5.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Защита данных и соответствие регуляторам</h1>
                        <div class="article-meta"><span>Стандарты: ФСТЭК, 152-ФЗ</span><span>Аудит:
                                ежегодный</span></div>
                        <div class="article-body">
                            <p>Комплексное обеспечение безопасности системы подготовки тендеров. Включает техническую
                                защиту, криптографию, контроль доступа и регулярный аудит.</p>
                            <h2>Компоненты защиты</h2>
                            <ul>
                                <li>SSL/TLS шифрование всех каналов передачи данных</li>
                                <li>Двухфакторная аутентификация (2FA) для всех ролей</li>
                                <li>Защита от DDoS и WAF-фильтрация запросов</li>
                                <li>Ежедневное инкрементное резервное копирование</li>
                            </ul>
                            <p>Система проходит обязательную аттестацию и получает сертификат соответствия требованиям
                                безопасности ГИС.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-update">Безопасность</span><span
                                class="news-tag tag-law">ФСТЭК</span></div>
                    </div>
                </div>
    ...
    <?php if (is_logged_in()): ?>
        <form method="POST" action="order_handler.php" style="margin-top: 12px;">
            <input type="hidden" name="service_name" value="Информационная безопасность">
