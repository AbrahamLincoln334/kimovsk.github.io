...
<head>
    ...
    <title>Антикоррупционный аудит | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Антикоррупционный <span>аудит процедур</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv15.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Выявление рисков и конфликтов интересов</h1>
                        <div class="article-meta"><span>Закон: 273-ФЗ</span><span>Прозрачность:
                                максимальная</span></div>
                        <div class="article-body">
                            <p>Независимая проверка закупочных процедур на соответствие антикоррупционному
                                законодательству. Выявление аффилированности, завышения цен и ограничений конкуренции.
                            </p>
                            <h2>Методология</h2>
                            <ul>
                                <li>Анализ связей участников закупки и сотрудников</li>
                                <li>Проверка критериев оценки на необъективность</li>
                                <li>Мониторинг аномальных цен и отклонений</li>
                                <li>Формирование отчёта для контрольно-наблюдательных органов</li>
                            </ul>
                            <p>Помогаем администрации минимизировать репутационные и правовые риски.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-law">Антикоррупция</span><span
                                class="news-tag tag-update">Риски</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-docflow.php">
                                <div class="sidebar-news-date">
                                    <div class="day"></div>
                                </div>
                                <h4>Автоматизация документооборота</h4>
                            </a></div>
                    </div>
                    <div class="sidebar-card">
