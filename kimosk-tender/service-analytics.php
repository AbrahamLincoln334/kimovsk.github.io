...
<head>
    ...
    <title>Аналитика и отчётность | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Аналитика и <span>отчётность</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv10.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Интерактивные дашборды и KPI</h1>
                        <div class="article-meta"><span>Форматы: PDF, Excel</span></div>
                        <div class="article-body">
                            <p>Разработка и настройка модуля аналитики для визуализации закупочной деятельности.
                                Позволяет руководству отслеживать ключевые метрики в реальном времени.</p>
                            <h2>Возможности</h2>
                            <ul>
                                <li>Дашборды с графиками, диаграммами и тепловыми картами</li>
                                <li>Фильтрация по отделам, категориям, периодам</li>
                                <li>Автоматическое формирование отчётов по расписанию</li>
                                <li>Прогнозирование бюджетных расходов на основе ML</li>
                            </ul>
                            <p>Интегрируется с 1С, ЕИС и внутренними бухгалтерскими системами.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-update">Аналитика</span><span
                                class="news-tag tag-dev">BI</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-staff-training.php">
