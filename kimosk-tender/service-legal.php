...
<head>
    ...
    <title>Юридический аудит | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Юридический <span>аудит документации</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv8.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Экспертиза на соответствие законодательству</h1>
                        <div class="article-meta"><span>Глубина: 100%</span><span>Штрафы: 0</span></div>
                        <div class="article-body">
                            <p>Независимая проверка тендерной документации, проектов контрактов и протоколов на предмет
                                соответствия 44-ФЗ, 223-ФЗ и внутренним нормативным актам муниципального образования.
                            </p>
                            <h2>Объекты проверки</h2>
                            <ul>
                                <li>Извещения и документация о закупке</li>
                                <li>Технические задания и спецификации</li>
                                <li>Критерии оценки и порядок определения победителя</li>
                                <li>Условия контракта и гарантийные обязательства</li>
                            </ul>
                            <p>По итогам аудита предоставляется развёрнутое заключение с перечнем выявленных рисков и
                                рекомендациями по их устранению до публикации в ЕИС.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-law">Аудит</span><span
                                class="news-tag tag-update">Комплаенс</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-procurement.php">
                                <div class="sidebar-news-date">
                                    <div class="day"></div>
                                </div>
                                <h4>Сопровождение закупок</h4>
                            </a></div>
                    </div>
                    <div class="sidebar-card">
