...
<head>
    ...
    <title>Экспертиза НМЦК | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Экспертиза <span>НМЦК</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv14.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Обоснование начальной цены контракта</h1>
                        <div class="article-meta"><span>Метод: рыночный</span><span>Точность: ±5%</span></div>
                        <div class="article-body">
                            <p>Профессиональное обоснование НМЦК с использованием коммерческих предложений, нормативных
                                расчётов и аналитики рынка.</p>
                            <h2>Источники данных</h2>
                            <ul>
                                <li>Запрос коммерческих предложений (минимум 3)</li>
                                <li>Рыночная аналитика и индексы цен</li>
                                <li>Реестр контрактов ЕИС (исторические данные)</li>
                                <li>Нормативные расчёты по приказам Минфина</li>
                            </ul>
                            <p>Формируем полный пакет документов для ФАС, исключающий отмену закупки из-за некорректного
                                ценообразования.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-law">НМЦК</span><span
                                class="news-tag tag-update">Финансы</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-tz.php">
    ...
    <?php if (is_logged_in()): ?>
        <form method="POST" action="order_handler.php" style="margin-top: 12px;">
            <input type="hidden" name="service_name" value="Экспертиза НМЦК">
