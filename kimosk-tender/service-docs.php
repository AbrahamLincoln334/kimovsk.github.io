...
<head>
    ...
    <title>Подготовка документации | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Подготовка <span>тендерной документации</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv3.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Автоматизация подготовки документации</h1>
                        <div class="article-meta"><span>Экономия времени: 70%</span><span>Соответствие:
                                44-ФЗ</span></div>
                        <div class="article-body">
                            <p>Разработка системы автогенерации извещений, технических заданий и проектов контрактов на
                                основе утверждённых шаблонов. Исключает человеческий фактор и снижает риск отклонения
                                заявки ФАС.</p>
                            <h2>Возможности модуля</h2>
                            <ul>
                                <li>Конструктор документов с drag-and-drop полями</li>
                                <li>Валидация на соответствие актуальным нормам права</li>
                                <li>Экспорт в PDF, DOCX, XML для ЕИС</li>
                                <li>Версионирование и история изменений</li>
                            </ul>
                            <p>Сотрудники заполняют только специфические параметры закупки, остальное система
                                подставляет автоматически.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-dev">Документы</span><span
                                class="news-tag tag-law">44-ФЗ</span></div>
                    </div>
                </div>
    ...
    <?php if (is_logged_in()): ?>
        <form method="POST" action="order_handler.php" style="margin-top: 12px;">
            <input type="hidden" name="service_name" value="Подготовка документации">
