...
<head>
    ...
    <title>Техническая поддержка | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Техническая <span>поддержка 24/7</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv12.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Стабильная работа без простоев</h1>
                        <div class="article-meta"><span>SLA: 99.9%</span><span>Ответ: <15 мин></span>
                        </div>
                        <div class="article-body">
                            <p>Круглосуточное сопровождение информационной системы подготовки тендеров. Мониторинг,
                                резервное копирование, оперативное устранение инцидентов.</p>
                            <h2>Гарантии SLA</h2>
                            <ul>
                                <li>Мониторинг серверов 24/7/365</li>
                                <li>Ежедневные бэкапы с хранением 90 дней</li>
                                <li>Автоматическое применение патчей безопасности</li>
                                <li>Выделенный менеджер инцидентов</li>
                            </ul>
                            <p>Работаем по договору IT-аутсорсинга с фиксированной ежемесячной оплатой.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-update">Поддержка</span><span
                                class="news-tag tag-dev">SLA</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-eis-setup.php">
