...
<head>
    ...
    <title>Настройка ЕИС | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Настройка и <span>аудит ЕИС</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv11.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Оптимизация работы с ЕИС</h1>
                        <div class="article-meta"><span>Аудит: бесплатный</span><span>Настройка: 3-5 дней</span>
                        </div>
                        <div class="article-body">
                            <p>Профессиональная настройка параметров работы в ЕИС, обновление шаблонов и интеграция с
                                внутренними системами администрации.</p>
                            <h2>Что делаем</h2>
                            <ul>
                                <li>Обновление справочников ОКПД2 и ОКВЭД</li>
                                <li>Настройка ролей и прав доступа в ЕИС</li>
                                <li>Интеграция внутренних реестров с ЕИС</li>
                                <li>Обучение сотрудников работе с новым API</li>
                            </ul>
                            <p>Исключаем ошибки публикации и штрафы за нарушение сроков.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-update">Настройка</span><span
                                class="news-tag tag-dev">ЕИС</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-techsupport.php">
