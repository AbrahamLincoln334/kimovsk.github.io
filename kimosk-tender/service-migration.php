...
<head>
    ...
    <title>Миграция данных | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Миграция <span>архивных данных</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv18.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Безопасный перенос в новую систему</h1>
                        <div class="article-meta"><span>Потери данных: 0%</span><span>Проверка: полная</span>
                        </div>
                        <div class="article-body">
                            <p>Организация процесса переноса архивов закупок, контрактов и документации из legacy-систем
                                в новую платформу подготовки тендеров.</p>
                            <h2>Этапы миграции</h2>
                            <ul>
                                <li>Аудит исходных данных и маппинг полей</li>
                                <li>Разработка скриптов трансформации</li>
                                <li>Тестовый перенос и валидация целостности</li>
                                <li>Продуктивная миграция в ночное окно</li>
                                <li>Резервное копирование исходных баз</li>
                            </ul>
                            <p>Гарантируем сохранность исторических данных и их полную доступность в новой системе.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-dev">Миграция</span><span
                                class="news-tag tag-update">Архив</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-crm.php">
