...
<head>
    ...
    <title>Обучение и поддержка | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Обучение и <span>техническая поддержка</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv6.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Передача знаний и сопровождение</h1>
                        <div class="article-meta"><span>Формат: очно/онлайн</span><span>Поддержка: 24/7</span>
                        </div>
                        <div class="article-body">
                            <p>Комплексная программа обучения сотрудников администрации работе с системой подготовки
                                тендеров и последующее гарантийное сопровождение.</p>
                            <h2>Что включено</h2>
                            <ul>
                                <li>Проведение 4 практических воркшопов</li>
                                <li>Разработка интерактивных руководств пользователя</li>
                                <li>Выделенная линия техподдержки (SLA 4 часа)</li>
                                <li>Регулярные обновления и патчи безопасности</li>
                            </ul>
                            <p>После обучения каждый сотрудник получает именной сертификат и доступ к базе знаний
                                проекта.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-event">Обучение</span><span
                                class="news-tag tag-update">Поддержка</span></div>
                    </div>
                </div>
    ...
    <?php if (is_logged_in()): ?>
        <form method="POST" action="order_handler.php" style="margin-top: 12px;">
            <input type="hidden" name="service_name" value="Обучение и поддержка">
