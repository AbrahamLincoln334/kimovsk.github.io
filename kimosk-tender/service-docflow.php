...
<head>
    ...
    <title>Автоматизация документооборота | Администрация Кимовский район</title>
...
<body>
    ...
    <section class="hero compact">
        <div class="container">
            <div class="hero-content">
                ...
                <h2>Автоматизация <span>документооборота</span></h2>
            </div>
        </div>
    </section>
    ...
    <div class="article-screenshot">
        <img src="images/serv16.jpg" alt="Скриншот">
        <span class="placeholder">Место для скриншота</span>
    </div>
    <div class="article-content">
                        <h1>Безбумажные процессы и маршруты согласования</h1>
                        <div class="article-meta"><span>Экономия времени: 60%</span><span>ЭЦП:
                                поддерживается</span></div>
                        <div class="article-body">
                            <p>Настройка автоматических маршрутов согласования тендерной документации и интеграция с
                                системой электронного документооборота (СЭД).</p>
                            <h2>Функции</h2>
                            <ul>
                                <li>Настройка цепочек согласования по ролям</li>
                                <li>Интеграция с СЭД (Directum, 1С:Документооборот)</li>
                                <li>Поддержка квалифицированной электронной подписи</li>
                                <li>Автоматическое архивирование и классификация</li>
                            </ul>
                            <p>Сокращаем время подготовки документов с недель до часов.</p>
                        </div>
                        <div class="article-tags"><span class="news-tag tag-dev">СЭД</span><span
                                class="news-tag tag-update">Автоматизация</span></div>
                    </div>
                </div>
                <aside class="article-sidebar">
                    <div class="sidebar-card">
                        <h3>Другие услуги</h3>
                        <div class="sidebar-news-item"><a href="service-anticorruption.php">
                                <div class="sidebar-news-date">
                                    <div class="day"></div>
                                </div>
                                <h4>Антикоррупционный аудит</h4>
                            </a></div>
                    </div>
                    <div class="sidebar-card">
